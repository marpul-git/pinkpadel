    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            // Asegurarse de que al menos una sección esté seleccionada.
        ...
        foreach ($selectedSections as $sectionId) {
            $section = Section::find($sectionId+1);
            if ($section) {
                $event->sections()->attach($sectionId+1);
            }
        }
    ...
    public function update(Request $request, Event $event)
    {
        ...
        return redirect()->route('admin.events.index')->with('info', 'El evento se actualizó con éxito');
